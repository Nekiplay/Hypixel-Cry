package com.example.examplemod.DataInterpretation;

import com.example.examplemod.EventIDs;
...
public class DataExtractor {
    ...
    public class ScoreUtils {
        ...
        public boolean isNotNull(Score s) {
    ...
    public List<String> getSidebarLines() {
        ...
        List<Score> list = Lists.newArrayList(Iterables.filter(scores, new ScoreUtils()::isNotNull));
    ...
    private boolean isInvFull () {
        InventoryPlayer ip =  Main.mc.thePlayer.inventory;
        for (int i = 0;i < 36;i++) {
