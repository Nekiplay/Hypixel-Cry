...
public class RenderUtils {
    ...
    public static void renderWaypointText(String str, BlockPos pos, float partialTicks) {
        renderWaypointText(str, pos.getX(), pos.getY(), pos.getZ(), partialTicks);
    }
    ...
    public static void drawTracer(Entity entity, Color color, float partialTicks) {
        ...
        glVertex3d(eyeVector.xCoord, player.eyeHeight + eyeVector.yCoord, eyeVector.zCoord);
        glVertex3d(x, y, z);;
    }
    public static void drawNametag(String str, BlockPos pos, float partialTicks) {
        drawNametag(str, pos.getX() + 0.5, pos.getY() + 1.5, pos.getZ() + 0.5, partialTicks);
    }
