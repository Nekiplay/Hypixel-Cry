...
import com.nekiplay.hypixelcry.features.system.PathFinder;
...
public class PathFinderCommand {
    ...
    public static OnlyRenderProcess process = new OnlyRenderProcess(BaritoneAPI.getProvider().getPrimaryBaritone());
        ...
        dispatcher.register(
                ClientCommandManager.literal("path")
                                        ...
                                        .then(ClientCommandManager.argument("y", IntegerArgumentType.integer())
                                                .then(ClientCommandManager.argument("z", IntegerArgumentType.integer())
                                                        .executes(context -> {
                                                            ...
                                                            PathFinder.addOrUpdatePath(CUSTOM_PATH_ID, targetPos, DEFAULT_COLOR, CUSTOM_PATH_ID);
                        ...
                        .then(ClientCommandManager.literal("clear")
                                .executes(context -> {
                                    if (PathFinder.hasPath(CUSTOM_PATH_ID)) {
                                        PathFinder.removePath(CUSTOM_PATH_ID);
